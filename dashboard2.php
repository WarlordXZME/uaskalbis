<?php
    session_start();
    if (!isset($_SESSION['usernameglobal2'])){
        header("Location: soal9.php");
    }
    $username = $_SESSION['usernameglobal2'];
...
<div class="login-form">
    <form action="" method="post">
        ...
        <div class="form-group">
            <label class="text-center">Bapak/Ibu <?php echo $username ;?> berhasil login pada <?php echo $_SESSION['logintime2']; ?>  </label>
        </div>
        <div class="form-group">
